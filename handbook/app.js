...
const trip = {
  ...
  itinerary: [
    ...
    { date:'9/21', day:'MON', city:'New York', page:'nyc.html#nyc-0921', title:'Lower East Side 城市紋理＋Soothr', summary:'沿 Essex、Seward Park 與 Orchard Street 讀移民街區；20:00 Soothr 已訂。', route:'Essex Street → Seward Park → Orchard Street → East Village → Soothr 20:00', status:'confirmed', images:['nyc-washington-square.jpg','nyc-jackson-heights.jpg','katz-pastrami.jpg','nyc-sunset.jpg'] },
  ...
  bookings: [
    ...
    { type:'DINNER · RESERVED', date:'9/21', title:'Soothr', facts:['20:00 · 1 位','已訂位','Lower East Side／East Village 行程終點','19:45 前抵達'] },
